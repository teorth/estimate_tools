...
**Important note**: This version of the repository is no longer being actively maintained.  The latest version of the formalization is available [here](https://github.com/teorth/analysis).
